            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                ...
                <div class="text-right">
                    ...
                    <div class="flex gap-2 mt-2 justify-end">
                        ...
                        @endif
                        <form action="{{ route('bills.destroy', $bill) }}" method="POST" onsubmit="return confirm('Delete {{ addslashes($bill->type) }} bill for ₱{{ number_format($bill->amount, 2) }}? This cannot be undone.')" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="px-2 py-1.5 border border-red-200 rounded-lg text-xs font-medium text-red-600 hover:bg-red-50 transition-colors">
