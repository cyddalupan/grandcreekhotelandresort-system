...
@section('page-header', 'Add Item')
@section('title', 'Add Item - ' . config('app.name'))

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm p-6 md:p-8">
        <h1 class="text-xl md:text-2xl font-bold text-blue-900 mb-6">Add Inventory Item</h1>
        ...
        <form action="{{ route('inventory.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="current_stock" id="current_stock" value="{{ old('current_stock', 0) }}" min="0"
                           class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                ...
                <div>
                    ...
                    <input type="text" name="unit" id="unit" value="{{ old('unit', 'pieces') }}"
                           class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="0.01" name="purchase_cost" id="purchase_cost" value="{{ old('purchase_cost', 0) }}" min="0"
                           class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="selling_price" id="selling_price" value="{{ old('selling_price', 0) }}" min="0"
                           class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
