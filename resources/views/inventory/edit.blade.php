...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm p-6 md:p-8">
        ...
        <div class="mt-8 pt-6 border-t border-red-100">
            ...
            <p class="text-xs text-gray-500 mb-4">Once deleted, this cannot be undone.</p>
            <form action="{{ route('inventory.destroy', $item) }}" method="POST" onsubmit="return confirm('Delete {{ addslashes($item->name) }}? This cannot be undone.')">
                @csrf
                @method('DELETE')
