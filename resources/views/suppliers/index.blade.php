        ...
        <div class="bg-white rounded-xl shadow-sm border-l-4 border-l-green-500 p-4 md:p-6">
            ...
            <div class="space-y-2 text-xs md:text-sm">
                ...
                <div class="flex gap-2 mt-3 md:mt-4">
                    ...
                    <form action="{{ route('suppliers.destroy', $supplier) }}" method="POST" onsubmit="return confirm('Delete supplier \"{{ addslashes($supplier->name) }}"? This cannot be undone.')" class="inline">
                        @csrf
                        @method('DELETE')
